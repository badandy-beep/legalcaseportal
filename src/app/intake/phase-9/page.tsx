...
export default function Phase9Page() {
  ...
  return (
    <>
      <div className="card">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-[#111827] mb-2">Document Upload</h1>
        ...
        <form id="phase-9-form" onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-3 z-10">
        <div className="max-w-2xl mx-auto">
          <button type="submit" form="phase-9-form" disabled={loading} className="w-full btn-primary flex items-center justify-center gap-2">
