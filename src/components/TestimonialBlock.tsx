  ...
  return (
    <section className="bg-[#F8F9FA] border-t border-b border-[#E2E8F0] py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-xs font-bold tracking-widest uppercase text-[#475569] text-center mb-10">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 md:p-12 shadow-sm relative">
            ...
            <blockquote className="text-[#1e293b] text-lg md:text-xl leading-relaxed italic mb-8" style={{fontFamily:'Georgia,serif'}}>
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-[#0a1628] flex items-center justify-center flex-shrink-0">
                <span className="text-[#d4a843] font-bold text-lg">M</span>
              </div>
              <div>
                <p className="font-bold text-[#0a1628] text-sm">Mary H.</p>
                <p className="text-[#475569] text-xs">Mother of a vaccine-injured child · Age 38 · Florida</p>
                <p className="text-[#d4a843] text-xs mt-1">★★★★★</p>
              </div>
            </div>
            <p className="text-[#94a3b8] text-xs mt-6 italic">* Name and identifying details changed to protect client privacy. Quote reflects a composite of client experiences.</p>
          </div>
        </div>
      </div>
    </section>
