export const articles = [
  {
    slug: 'dan-fleuette-autism-justice-documentary-filmmaker',
    ...
    imageCaption: 'Dan Fleuette — documentary filmmaker, inaugural producer of Bannon\'s War Room, and media advisor to the Autism Justice Foundation.',
    excerpt: 'For two decades, Dan Fleuette documented America\'s political battles from behind the lens. Now the award-winning filmmaker and author has turned his focus to autism justice — and he is bringing his full creative arsenal to the families who need it most.',
    body: [
      { type: 'vicp_pill', label: 'Know a family affected by autism? Refer them →' },
      { type: 'p', text: 'Dan Fleuette has spent his career making sure the stories that powerful people want buried get told anyway. He has been doing it since 2004. He will be doing it long after the cameras stop rolling on whatever project comes next. But something shifted for him. Something always does when you get close enough to the truth.' },
      { type: 'p', text: 'The Bellingham, Massachusetts native graduated college with a degree in photography, then set it aside for film. That decision led him to Washington, D.C. — a city he never expected to call home — and to a collaboration with Steve Bannon that would span more than two decades and produce some of the most politically consequential documentary films of the modern era.' },
      { type: 'h2', text: 'A Filmography Written in Fire' },
      { type: 'p', text: 'His filmography reads like a chronicle of the American populist movement. In the Face of Evil: Reagan\'s War in Word and Deed (2004) was where it began — Bannon\'s debut documentary, and Fleuette\'s introduction to the Washington world. From there came Generation Zero, which examined the cultural and financial roots of the 2008 financial collapse. Then The Undefeated (2011), a portrait of Sarah Palin. Then Occupy Unmasked, which dissected the Occupy Wall Street movement alongside Andrew Breitbart.' },
      { type: 'p', text: 'Then came Clinton Cash (2016) — the documentary adaptation of Peter Schweizer\'s blockbuster exposé that helped cement Bannon\'s ascent to CEO of the Trump 2016 campaign. That same year, Fleuette produced the Clinton Cash graphic novel, which reached #1 on the New York Times bestseller list. Most recently, he co-produced Government Gangsters (2024), based on the bestselling book by former Deputy Director of National Intelligence Kash Patel, which premiered at the Republican National Convention. In January 2026, he wrote, directed, and co-produced The Sleeping Giant — a documentary on the events surrounding January 6th — which premiered on Real America\'s Voice.' },
      { type: 'vicp_pullquote', quote: 'The autism community needed what he had spent his career building. Not a billboard. Not a press release. A record. A narrative. A voice that could not be silenced.', attribution: 'Autism Justice Foundation', linkText: 'See how Alpha Law Group is fighting for these families →' },
      { type: 'h2', text: 'The War Room Years' },
      { type: 'p', text: 'Fleuette was the inaugural producer of Bannon\'s War Room, which launched on October 21, 2019, and grew into one of the most-watched political programs in America. He watched it scale from a bare studio to a broadcast juggernaut — tracking the viewer numbers in real time, knowing they were building something that would outlast any single news cycle.' },
      { type: 'p', text: 'In 2024 he turned that five-year front-row seat into a 500-page portrait book, Rebels, Rogues, and Outlaws: A Pictorial History of WarRoom, capturing 90 high-profile figures from the conservative movement through his lens. Steve Bannon called Fleuette one of the country\'s best photographers. Jack Posobiec called it the best coffee table book he had ever seen in his life. The book dropped on October 29, 2024 — the same day Bannon walked out of Danbury Federal Prison.' },
      { type: 'h2', text: 'Austin, Texas. November 2025. A Room Full of Families.' },
      { type: 'p', text: 'When Fleuette arrived at the Children\'s Health Defense Moment of Truth conference in Austin, he arrived as a filmmaker who had spent a career documenting institutions and the people who fought them. The sold-out conference drew roughly 1,000 attendees in person and another 1,000 via livestream, featuring senators, surgeons general, epidemiologists — and most powerfully — families.' },
      { type: 'p', text: 'What he witnessed in that room changed his calculus. He listened to scientists question the official narrative on autism causation. He listened to parents describe watching their healthy children regress after vaccination. He saw in those parents the same fire he had spent twenty years documenting in political warriors — a refusal to accept an answer that didn\'t match what they had witnessed with their own eyes. Fleuette left Austin with a conviction: the autism community needed a storyteller who knew how to make the powerful pay attention.' },
      { type: 'vicp_stat', stat: '1 in 36', statLabel: 'American children has been diagnosed with autism. Dan Fleuette saw those families in Austin. Now he is helping tell their story — and Alpha Law Group is fighting for their compensation.', linkText: 'Check Your Family\'s Eligibility →' },
      { type: 'h2', text: 'The AJF Commission' },
      { type: 'p', text: 'Dan Fleuette has joined the Autism Justice Foundation as a media advisor and ongoing documentary collaborator. His role is what you would expect from someone who has produced more than a dozen films: he tells the story in a way that reaches the people who need to hear it. He brings to the AJF not just technical skill but a network built across two decades at the intersection of media, politics, and accountability journalism.' },
      { type: 'p', text: 'For the autism families navigating the federal Vaccine Injury Compensation Program, Dan Fleuette\'s arrival in this space means something specific: their story now has a storyteller who knows exactly how to make the powerful pay attention. He has been doing it since 2004. He is not stopping now.' },
      { type: 'vicp_close', personName: 'Dan Fleuette' },
    ],
  },
  {
